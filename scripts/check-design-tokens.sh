...
BASELINE_DARK_VARIANT=89       # dark: Tailwind 变体（行数口径；历史注释见 git 记录）
                               # 2026-08-17 W0 锁进度 196→182（实测回归）；批G-1 KnowledgeBase 收编 182→111（71 行）；
                               # 批G-2 ProductsManager+compiledProductsTemplates 收编 111→89（22 行）；批 G 目标 ≤10
