...
BASELINE_DARK_VARIANT=33       # dark: Tailwind 变体（行数口径；历史注释见 git 记录）
                               ...
                               # 批G-5 AdminPanel+DesignTuner 收编 53→44；批G-6 DataCenter+Assistant+AgentFormBlock 收编 44→33；批 G 目标 ≤10
