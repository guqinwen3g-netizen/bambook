...
- 当前波次：**W-C 权限收口进行中**（REQ2-11 已拍板 DR-048：双主体事实成立但暂缓至 v1.1 首批，D-1~D-5 五格全拍板；W-C 收窄为两件事：① 七角色权限走查 ② 30 页权限销号。侦察已挖出差距：代码 8 角色滞后于文档 7 角色 GAP-R11/legacy 降级映射放大权限/pricing 等 12 路由文件无角色门/4 业务页无视图门禁含财务管理/27 页页内零权限逻辑）
