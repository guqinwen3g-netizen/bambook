      ...
      <div className="bds-modal" style={{ width: '42rem', maxHeight: '80vh', overflowY: 'auto' }} onClick={(e) => e.stopPropagation()}>
        ...
        {activeTab === 'declarations' && (
          <div className="grid grid-cols-2 gap-3">
            ...
            <div><label className="block text-xs mb-1" style={{ color: 'var(--text-tertiary)' }}>申报日期</label><CapsuleDateInput value={declForm.declarationDate || ''} onChange={v => setDeclForm({ ...declForm, declarationDate: v })} className="bds-input sm" /></div>
        ...
        {activeTab === 'lettersOfCredit' && (
          <div className="grid grid-cols-2 gap-3">
            ...
            <div><label className="block text-xs mb-1" style={{ color: 'var(--text-tertiary)' }}>开证日期</label><CapsuleDateInput value={lcForm.issueDate || ''} onChange={v => setLcForm({ ...lcForm, issueDate: v })} className="bds-input sm" /></div>
            <div><label className="block text-xs mb-1" style={{ color: 'var(--text-tertiary)' }}>有效期</label><CapsuleDateInput value={lcForm.expiryDate || ''} onChange={v => setLcForm({ ...lcForm, expiryDate: v })} className="bds-input sm" /></div>
            ...
            <div><label className="block text-xs mb-1" style={{ color: 'var(--text-tertiary)' }}>最迟装运期</label><CapsuleDateInput value={lcForm.shipmentDeadline || ''} onChange={v => setLcForm({ ...lcForm, shipmentDeadline: v })} className="bds-input sm" /></div>
            <div><label className="block text-xs mb-1" style={{ color: 'var(--text-tertiary)' }}>交单期限</label><CapsuleDateInput value={lcForm.presentationDeadline || ''} onChange={v => setLcForm({ ...lcForm, presentationDeadline: v })} className="bds-input sm" /></div>
        ...
        {activeTab === 'taxRefunds' && (
          <div className="grid grid-cols-2 gap-3">
            ...
            <div><label className="block text-xs mb-1" style={{ color: 'var(--text-tertiary)' }}>出口日期</label><CapsuleDateInput value={trForm.exportDate || ''} onChange={v => setTrForm({ ...trForm, exportDate: v })} className="bds-input sm" /></div>
