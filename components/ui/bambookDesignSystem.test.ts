...
describe('Bambook OS design system contract', () => {
  ...
  it('declares layout, adaptive color, state, component, content, and page-generation grammar', () => {
    ...
    expect(BAMBOOK_LAYOUT_GRAMMAR.relationsDetailWorkspace.canvas).toBe('1130px');
  ...
  it('loads the flat surface stylesheet as the global no-shadow and no-rim override', () => {
    ...
    expect(osVNextCss).toContain('--bambook-rdl-panel-fill-light: rgb(255 255 255 / 0.50);');
    expect(osVNextCss).toContain('--bambook-rdl-card-fill-light: rgb(255 255 255 / 0.44);');
    expect(osVNextCss).toContain('--bambook-rdl-panel-fill-dark: rgb(24 31 42 / 0.58);');
    ...
    expect(osVNextCss).toContain('--bambook-rdl-panel-fill-light: rgb(255 255 255 / 0.34);');
    expect(osVNextCss).toContain('--bambook-rdl-card-fill-light: rgb(255 255 255 / 0.28);');
