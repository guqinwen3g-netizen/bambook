...
export const BAMBOOK_OS = {
  ...
  layout: {
    ...
    desktopPageXClass: 'px-7',
    desktopPanelRowClass: 'flex-1 min-h-0 flex px-7 pt-0 bambook-main-panel-bottom-inset gap-4 overflow-visible',
    desktopBackstagePanelRowClass: 'flex-1 min-h-0 flex px-7 pt-0 bambook-main-panel-bottom-inset gap-4 overflow-visible w-full h-full',
