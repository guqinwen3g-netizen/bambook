...
export const BAMBOOK_OS = {
  ...
  controls: {
    ...
    title: {
      ...
      actionButton:
        'h-9 px-4 rounded-2xl border flex items-center justify-center gap-2 shrink-0 transition-colors text-[11px] font-light tracking-wide',
      ...
      viewSwitch: 'h-9 shrink-0 rounded-2xl border p-1 flex items-center gap-1',
      viewSwitchButton:
        'h-7 rounded-[14px] px-3 text-[11px] font-light tracking-wide transition-[background,color] duration-200',
