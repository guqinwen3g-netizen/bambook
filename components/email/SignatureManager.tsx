...
const SignatureManager: React.FC<Props> = ({ isOpen, onClose, isDarkMode }) => {
  ...
  return (
    <div className="absolute inset-0 bg-[var(--mask-bg)] backdrop-blur-sm backdrop-saturate-[var(--mask-saturate)] z-[90] flex items-center justify-center p-6 animate-in fade-in duration-300">
