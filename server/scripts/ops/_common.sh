...
KNOWLEDGE_API_URL="${BAMBOOK_OPS_KNOWLEDGE_API_URL:-http://127.0.0.1:8090/bambook/health}"
LOCAL_PUBLIC_API_URL="${BAMBOOK_OPS_LOCAL_PUBLIC_API_URL:-http://127.0.0.1:8090/bambook/api/health}"
PUBLIC_API_URL="${BAMBOOK_OPS_PUBLIC_API_URL:-https://jiangsupanda.com/bambook/api/health}"
PUBLIC_KNOWLEDGE_URL="${BAMBOOK_OPS_PUBLIC_KNOWLEDGE_URL:-https://jiangsupanda.com/bambook/health}"
